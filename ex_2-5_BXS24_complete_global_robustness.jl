...
X_0 = IntervalBox(interval(-10, 10), interval(-10, 10))
ϵ_max = 0.25
p_in = [[interval(-ϵ_max, ϵ_max)], [interval(-ϵ_max, ϵ_max)]]
p_out = deepcopy(p_in)
G = [interval(minus_inf, δ - 0.0001), interval(0.0001, plus_inf), interval(minus_inf, δ - 0.0001), interval(0.0001, plus_inf)]
